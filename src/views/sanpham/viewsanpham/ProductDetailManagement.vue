...
import { getCTSPBySanPham, getSerialsByCtspId, createSerialsBatch, updateSerial, updateSerialStatus, deleteSerial, importSerialsFromExcel, updateChiTietSanPham, deleteCTSP, deleteCTSPWithCascade, getHinhAnhByCtspId } from '@/service/sanpham/SanPhamService'
