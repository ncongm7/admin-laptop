...
.btn-outline-primary:hover { background: #e0f2fe; color: #0284c7; }
.btn-outline-warning:hover { background: #fef9c3; color: #ca8a04; }
.btn-outline-success:hover { background: #dcfce7; color: #16a34a; }
